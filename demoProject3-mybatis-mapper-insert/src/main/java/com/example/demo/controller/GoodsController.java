...
@Controller
// class명을 Controller로 작성하면 기존에 Spring에 작성하는 Controller와 충돌이 나tj
// Spring 안에 있는 Controller 기능을 사용하지 못함
public class GoodsController {
	/*
	@GetMapping("/") // 맨 앞 페이지에서 볼 화면 띄우기
	public String registerForm(Model model) {
		//db에 값을 넣을 수 있도록 new Goods() 이용해서 값이 들어갈 공간을 비워서 만들어주기
	...
	*/
	...
	public String insertGoods(Goods goods, Model model) {
		 ...
		 * 자동으로 Goods.java 라는 곳에 일치하는 변수명에 form에 작성하는 값이 바로바로
		 * 임시저장(할당됨) 
		 * 
